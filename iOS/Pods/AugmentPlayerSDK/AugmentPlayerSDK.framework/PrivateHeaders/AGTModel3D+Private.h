...
typedef NS_ENUM(NSInteger, AGTModel3DPlacement) {
    AGTModel3DPlacementUnknown,
    AGTModel3DPlacementFloor,
    AGTModel3DPlacementTable,
};
...
// We keep `placement` property public to specify explicitly that we need this in JSON object
@property (nonatomic, copy, readonly) NSString *placement;
@property (nonatomic, readonly) AGTModel3DPlacement model3DPlacement;
